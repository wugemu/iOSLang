...
- (void)setPicImageStr:(NSString *)imageStr defaultImageStr:(NSString *)defaultImageStr
{
    ...
    [self sd_setImageWithURL:[NSURL URLWithString:imageStr] placeholderImage:LOCAL_IMAGE(defaultImageStr) completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
...
- (void)setPicImageStr:(NSString *)imageStr size:(CGSize)size
{
    ...
    UIImage  *placeImg= [UIImage placeholderImageWithSize:size];
    [self sd_setImageWithURL:[NSURL URLWithString:imageStr] placeholderImage:placeImg completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
    }];
